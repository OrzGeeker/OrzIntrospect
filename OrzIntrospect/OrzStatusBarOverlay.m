...
@implementation OrzStatusBarOverlay
...
- (void)tapped
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kOrzIntrospectNotificationStatusBarTapped object:nil];
}
